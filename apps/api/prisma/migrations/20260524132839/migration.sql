...
-- AddForeignKey
ALTER TABLE "owned_pet_vaccines" ADD CONSTRAINT "owned_pet_vaccines_animalId_fkey" FOREIGN KEY ("animalId") REFERENCES "owned_pets"("id") ON DELETE SET NULL ON UPDATE CASCADE;
