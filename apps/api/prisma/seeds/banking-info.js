export async function seedBankingInfo(prisma, { users }) {
    const { vetProfile1, vetProfile2, vetProfile3, secretaryUser1, referentUser1, } = users;
    await Promise.all([
        // ── Vétérinaires ────────────────────────────────────────────────────────────
...
//# sourceMappingURL=banking-info.js.map