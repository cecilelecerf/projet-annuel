export async function seedMedicalVisits(prisma, { users }) {
    const { vetoUser1, vetoUser2, vetoUser3, secretaryUser1, referentUser1 } = users;
    await Promise.all([
        ...
        prisma.medicalVisit.create({
            data: {
                ...
                certificateUrl: "https://storage.vetparc.fr/medical/leroy-embauche-2024.pdf",
        ...
        prisma.medicalVisit.create({
            data: {
                ...
                restrictions: "Port de charges limité à 10kg — surveillance lombaire recommandée",
                doctorName: "Dr. Émilie Rousseau",
                doctorRpps: "10012345678",
                occupationalHealthService: "CIAMT Paris",
                certificateUrl: "https://storage.vetparc.fr/medical/moreau-periodique-2025.pdf",
        ...
        prisma.medicalVisit.create({
            data: {
                ...
                certificateUrl: "https://storage.vetparc.fr/medical/garcia-embauche-2023.pdf",
        ...
        prisma.medicalVisit.create({
            data: {
                ...
                doctorRpps: "10012345678",
                occupationalHealthService: "CIAMT Paris",
                certificateUrl: "https://storage.vetparc.fr/medical/petit-reprise-2025.pdf",
        ...
        prisma.medicalVisit.create({
            data: {
                ...
                doctorRpps: "10098765432",
                occupationalHealthService: "ACMS Lyon",
                certificateUrl: "https://storage.vetparc.fr/medical/bernard-periodique-2025.pdf",
        ...
        prisma.medicalVisit.create({
            data: {
                ...
                doctorRpps: "10012345678",
                occupationalHealthService: "CIAMT Paris",
                certificateUrl: "https://storage.vetparc.fr/medical/collective-securite-2025.pdf",
                staffs: {
...
//# sourceMappingURL=medical-visit.js.map