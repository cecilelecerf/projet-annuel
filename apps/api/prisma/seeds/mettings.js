export async function seedMettings(prisma, { users, clinic1, veterinarianClinics, specialities, healthConditions, pets, vaccines, }) {
    const { vetoUser1, vetoUser2, secretaryUser1, clientUser1, clientUser2, vetProfile1, vetProfile2, vetProfile3, } = users;
        ...
        data: {
            ...
            animalMetting: {
                create: {
                    ...
                    petWeight: 28,
                    petSize: 58,
                    report: "Rex présente un souffle cardiaque léger. Surveillance recommandée.",
    ...
    await prisma.internalMettingParticipant.createMany({
        data: [
            { mettingId: baseInternal1.id, userId: vetoUser1.id, status: "ACCEPTED" },
            { mettingId: baseInternal1.id, userId: vetoUser2.id, status: "ACCEPTED" },
            {
                mettingId: baseInternal1.id,
                userId: secretaryUser1.id,
                status: "PENDING",
            },
            { mettingId: baseInternal2.id, userId: vetoUser1.id, status: "ACCEPTED" },
            { mettingId: baseInternal2.id, userId: vetoUser2.id, status: "DECLINED" },
        ],
    });
...
//# sourceMappingURL=mettings.js.map