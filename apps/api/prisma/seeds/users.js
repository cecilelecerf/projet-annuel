...
export async function seedUsers(prisma, clinics) {
    const [clinic1, clinic2] = clinics;
    const password = await hash("Password123!", 10);
    // ── Users ────────────────────────────────────────────────────────────────────
    const [adminUser, directorUser1, directorUser2, referentUser1, vetoUser1, vetoUser2, vetoUser3, secretaryUser1, clientUser1, clientUser2,] = await Promise.all([
        prisma.user.create({
            data: {
