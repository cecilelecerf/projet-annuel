...
<template>
  <div class="clinic-specialities-page">
    ...
    <div v-loading="loading" class="content-grid" :class="{ 'content-grid--editing': editing }">
      <div class="accordion-panel">
        <AcceptedSpecialitiesAccordion
          v-model:active-names="activeNames"
          :specialities="acceptedSpecialities"
          :editing="editing"
      ...
      <div v-if="editing" class="search-panel">
        <h3 class="search-panel-title">Ajouter une spécialité</h3>
        <AddSpecialitySearch
          :all-specialities="allSpecialities"
