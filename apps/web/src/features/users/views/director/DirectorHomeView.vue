...
import type { DirectorDashboard } from '@armali/schemas'

const router = useRouter()
const notify = useNotify()

const dashboard = ref<DirectorDashboard | null>(null)
...
async function load() {
  ...
  try {
    ...
    if (data.role !== 'DIRECTOR') return // garde-fou, ne devrait pas arriver (route déjà restreinte au rôle)
  ...
  <template v-else-if="dashboard">
    ...
    <div class="stats-grid">
      ...
      <div
        ...
        @click="router.push({ name: 'DIRECTOR.Boutique' })"
      >
    ...
    <div class="cards-row">
      <div class="card card--half">
        ...
        <el-button text @click="router.push({ name: 'DIRECTOR.Staff' })">
          Voir le personnel →
        </el-button>
      </div>
