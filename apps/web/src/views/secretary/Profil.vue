...
.profil-avatar { width: 72px; height: 72px; border-radius: 50%; background: #e6a23c; color: white; display: flex; align-items: center; justify-content: center; font-size: 24px; font-weight: 700; flex-shrink: 0; }
.profil-name { font-size: 22px; font-weight: 700; margin: 0 0 4px; }
.profil-role { background: #fdf6ec; color: #e6a23c; border-radius: 6px; padding: 2px 10px; font-size: 13px; font-weight: 500; }
