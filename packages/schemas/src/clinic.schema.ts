import { z } from 'zod'
import { clinicIdSchema, veterinarianIdSchema, veterinarianClinicIdSchema, availabilityIdSchema, specialityIdSchema } from './ids'
...
export const createVeterinarianClinicSchema = veterinarianClinicSchema.omit({ id: true })

export type VeterinarianClinic       = z.infer<typeof veterinarianClinicSchema>
export type CreateVeterinarianClinic = z.infer<typeof createVeterinarianClinicSchema>

// ── VeterinarianClinicAvailability ────────────────────────────────────────────
export const availabilityTypeSchema = z.enum(['recurring', 'specified', 'exception'])
...
export const createAvailabilitySchema = veterinarianClinicAvailabilitySchema.omit({ id: true })
export const updateAvailabilitySchema = createAvailabilitySchema.partial()

export type VeterinarianClinicAvailability       = z.infer<typeof veterinarianClinicAvailabilitySchema>
export type CreateVeterinarianClinicAvailability = z.infer<typeof createAvailabilitySchema>
export type UpdateVeterinarianClinicAvailability = z.infer<typeof updateAvailabilitySchema>
