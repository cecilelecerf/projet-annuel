import { z } from 'zod'
import { brandIdSchema, productIdSchema, foodIdSchema, productClinicIdSchema, clinicIdSchema, healthConditionIdSchema } from './ids'
...
export const foodHealthConditionSchema = z.object({
  id:                z.string().uuid().brand('FoodHealthConditionId'),
  foodId:            foodIdSchema,
  healthConditionId: healthConditionIdSchema,
  recommendation:    foodRecommendationSchema,
})

export const createFoodHealthConditionSchema = foodHealthConditionSchema.omit({ id: true })
...
export type CreateFoodHealthCondition = z.infer<typeof createFoodHealthConditionSchema>
